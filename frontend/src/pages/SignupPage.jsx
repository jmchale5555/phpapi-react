...
export default function SignupPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-md rounded-xl bg-white p-8 shadow-sm ring-1 ring-slate-200 transition-colors dark:bg-slate-900 dark:ring-slate-700">
      <h1 className="mb-6 text-2xl font-bold text-slate-900 dark:text-slate-100">Create account</h1>
      ...
      <form className="space-y-4" onSubmit={onSubmit}>
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300" htmlFor="confirm">
            Confirm password
          </label>
          <input
            id="confirm"
